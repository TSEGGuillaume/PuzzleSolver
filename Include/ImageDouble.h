...
class CImageDouble {
	...
	///////////////////////////////////////
		...
		_declspec(dllexport) std::vector<CImageDouble> pyramideLaplacienne(int hauteur = 5, int tailleFiltre = 5, double sigma = 1);
		_declspec(dllexport) CImageDouble diffoG(int tailleFiltre = 5, double sigma1 = 1, double sigma2 = 2);
